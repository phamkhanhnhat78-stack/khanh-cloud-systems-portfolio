...
const issues = [
  { id: "door-path", sceneKey: "scene-a", title: "Entrance route is missing floor tiles", instruction: "The walkway in front of the door has missing dark floor-tile gaps and one loose tile. Click it to pave the route back.", fixedTitle: "You paved the route back to the door.", real: "Customers outside could not reach the café entrance safely because the walkway tiles were missing.", cloud: "This is similar to a public subnet missing a route to an Internet Gateway. Without the route table entry, external users cannot reach public resources.", services: "Amazon VPC, Route Tables, Internet Gateway, Public Subnet" },
  { id: "open-sign", sceneKey: "scene-a", title: "Door sign shows the wrong state", instruction: "A hanging CLOSED sign is on the café door during service. Click it to flip the public endpoint back to OPEN.", fixedTitle: "You corrected the door sign.", real: "Customers thought the café was closed because the customer-facing door sign showed the wrong state.", cloud: "This is similar to DNS or domain routing pointing users to the wrong endpoint or unavailable service.", services: "Route 53, DNS, CloudFront or Load Balancer DNS name", textClass: "sign-text", textValue: "OPEN" },
  { id: "guard", sceneKey: "scene-a", title: "Entrance barrier blocks visitors", instruction: "A red NO ENTRY barrier is blocking the café doorway. Click it to remove the wrong access rule.", fixedTitle: "You removed the wrong entrance barrier.", real: "The café was open, but the entrance barrier blocked ordinary customers from entering.", cloud: "This is similar to an overly restrictive Security Group inbound rule that blocks legitimate web traffic.", services: "Security Groups, Inbound Rules, EC2 or Load Balancer" },
